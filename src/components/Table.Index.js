    ...
    <div className='w-full relative px-3'>
      ...
      <div className="sec m-auto my-10 space-y-8 w-1/2 mob:w-full flex flex-col">
        ...
        <div className="message bg-yellow-100 text-yellow-700 p-5 rounded-lg shadow-lg shadow-yellow-300/30 text-center border border-yellow-300/30">
          ...
          {/*<br></br>*/}
          We appreciate your participation and dedication to learning about Google GEN AI technologies. Hope you're making great strides in completing the Labs!<br></br><br /><b>Note: </b>Daily leaderboard updates at 12 Noon IST. Current data: <u>11th Nov 2024</u>.
<br></br>
      ...
      <table className='mx-auto table-fixed m-5 scroll-auto  ' >
        <thead className='shadow-md text-sm bg-blue-500 text-gray-200 sticky top-2 z-10'>
          <tr className='text-center'>
            <td className="rounded-ss-lg w-20 p-2 border-r-2 border-r-gray-300">Rank</td>
            <td className=" mob:visible w-80 p-2 border-r-2 border-r-gray-300">Student Name</td>
            {/* <td className="p-2 border-r-2 border-r-gray-300">Email</td> */}
            <td className="mob:visible p-2 px-10 border-r-2 border-r-gray-300 max-w-[150px]">Course Redemption Status</td>
            <td className="mob:visible p-2 px-10 border-r-2 border-r-gray-300 max-w-[150px]">All Skill Badges & Games Completed</td>
            <td className="mob:hidden p-2 border-r-2 border-r-gray-300 max-w-[150px]">Number of Skill Badges Completed</td>
            <td className="mob:hidden rounded-se-lg  p-2 border-r-2 border-r-gray-300 max-w-[150px]">Arcade Game Completion</td>
